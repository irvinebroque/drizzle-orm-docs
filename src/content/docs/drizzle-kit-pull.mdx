...
<Callout type="warning">
Cloudflare D1 application objects use `driver: "d1-object"` for generating bundled migrations. `pull` does not connect directly to a D1 application object. The `d1-http` driver is for legacy D1 database binding projects.
</Callout>
