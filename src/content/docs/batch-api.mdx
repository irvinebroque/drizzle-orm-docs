...
The D1 Batch API applies to the older `drizzle-orm/d1` database binding driver. New Cloudflare D1 projects should use `drizzle-orm/d1-object` and generated migrations instead.
</Callout>
