...
<Callout type="warning" title="Legacy D1 binding API">
The D1 Batch API applies to the older `drizzle-orm/d1` database binding driver. New Cloudflare D1 application-object projects should use `drizzle-orm/d1-object`, where SQL runs locally inside the Durable Object and migrations run through object methods.
</Callout>
