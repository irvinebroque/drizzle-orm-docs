...
<Callout type="info">
For Cloudflare D1 with `driver: "d1-object"`, Drizzle Kit generates bundled migrations. It does not connect directly for `push`, `pull`, `migrate`, or `studio`; apply generated migrations through an object method that calls `applyDrizzleMigrations()`.
</Callout>
