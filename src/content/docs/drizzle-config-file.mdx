...
<Callout type="info">
For Cloudflare D1 application objects, `driver: "d1-object"` is used to generate bundled migrations. Drizzle Kit does not connect directly to a D1 application object for `push`, `pull`, `migrate`, or `studio`; apply generated migrations through a primary-only Durable Object method.
</Callout>
